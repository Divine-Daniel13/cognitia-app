        ...
        <div className="relative rounded-[4rem] bg-slate-900 dark:bg-brand-950 p-12 lg:p-24 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="w-full sm:w-auto px-10 py-5 rounded-full bg-brand-600 hover:bg-brand-700 text-white font-bold text-xl shadow-2xl shadow-brand-600/20 transition-all hover:scale-105 active:scale-95">
                Get Started Free
              </button>
              <button className="w-full sm:w-auto px-10 py-5 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-bold text-xl border border-white/20 transition-all active:scale-95">
                Explore AI Avatars
              </button>
            </div>
